...
<p style="color:#003366;font-size:4vw;  text-align:center; margin-top:3vw;"><b>Add Disease</b></p>
  <form style="margin-left:40vw;" method="POST" action="addTreatmentScript.php" enctype="multipart/form-data">
  ...
  <label style="margin-right:1vw;">Fungicide:</label><select name="fungicide" >
      <?php
      include 'config.php';
      $sql="SELECT id,name FROM fungicides";
        $query=mysqli_query($con,$sql);
        while($row=mysqli_fetch_array($query)){
          ?>
  ...
  <label style="margin-right:1vw;">Dose:</label><input type="text" name="dose" value=""><br><br>
