...
<p style="color:#003366;font-size:4vw;  text-align:center; margin-top:3vw;"><b>Add Disease</b></p>
  <form style="margin-left:40vw;" method="POST" action="addDiseaseScript.php" enctype="multipart/form-data">
  <label style="margin-right:1vw;">Name:</label><input type="text" name="name" value=""><br><br>
  <label style="margin-right:1vw;">Severity:</label><input type="text" name="severity" value=""><br><br>
  <label style="margin-right:1vw;">Symptoms:</label><input type="text" name="symptoms" value=""><br><br>
